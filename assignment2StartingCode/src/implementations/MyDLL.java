...
public class MyDLL<E> implements ListADT<E> {
    ...
    /**
     * Overrides Object.equals(Object) to compare two ListADT implementations.
     */
    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof ListADT)) return false;
        ListADT<?> that = (ListADT<?>) o;
